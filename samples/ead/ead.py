...
"""
Mask R-CNN
Train on the toy Ead dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 ead.py train --dataset=/path/to/balloon/dataset --weights=coco
    # Resume training a model that you had trained earlier
    python3 ead.py train --dataset=/path/to/balloon/dataset --weights=last
    # Train a new model starting from ImageNet weights
    python3 ead.py train --dataset=/path/to/balloon/dataset --weights=imagenet
    # Apply color splash to an image
    python3 ead.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>
...
ROOT_DIR = os.path.abspath("/content/drive/My Drive/endoscopy-artefact-detection-_ead_-dataset/trainingData_semanticSegmentation.zip (Unzipped Files)/")
...
def train(model):
    ...
    dataset_train.load_ead(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    #dataset_val = EadDataset()
    #dataset_val.load_ead(args.dataset, "val")
    #dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        class InferenceConfig(EadConfig):
